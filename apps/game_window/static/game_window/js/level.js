...
// 	// objLoader.load("/static/game_window/images/bulbasaur/New_folder/Bulbasaur.obj", function (mesh) {
// 	// 	scene.add(mesh);
// 	// 	mesh.postion.set(0, 0, 5);

// 	// })

// 	var amb_light = new THREE.AmbientLight(0x404040)
// 	scene.add(amb_light)
...
// 		mesh.position.x += Math.sin(mesh.rotation.y + Math.PI / 2) * player.speed;
// 		mesh.position.z += -Math.cos(mesh.rotation.y + Math.PI / 2) * player.speed;
// 	}
